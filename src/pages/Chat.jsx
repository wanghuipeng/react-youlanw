...
class Chat extends Component {
	...
	getData = () => {
        fetch("/api/v6/article/ramble?appkey=145FB9D1-2643-4B18-B9EA-8CD2C44FAC00&client_id=test&token=e9505a27cfcf487a8760b8ad5963db8f&uid=56741ada71d03f4122b9f5a6&page=1&limit=15",
        {
        	mode: 'cors',
        	cache: 'default'
